...
# Hi, I'm Gantuul 👋 · こんにちは、Gantuulです 👋
...
ユーザー向けプロダクトから管理システム、コミュニティプラットフォームまで、本番環境で動くWebアプリケーションを開発しています。
...
| 分野 | 技術 |
|---|---|
| フロントエンド | React · TypeScript · Next.js · Tailwind CSS · Vite |
...
- モンゴル市場に特化したWebプロダクトを開発
- データベース設計からUI実装まで、フルスタックで対応可能
- 認証・管理画面・外部連携を含む本番アプリのリリース経験あり
